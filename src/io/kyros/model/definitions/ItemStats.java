...
public final class ItemStats {
    ...
    public static Map<Integer, ItemStats> itemStatsMap;
    public static Map<Integer, ItemEquipmentStats> wildernessStatsMap = new HashMap<>();
    public static void addWildernessStat(int itemId, int slot, int astab, int aslash, int acrush, int amagic, int arange, int dstab, int dslash, int dcrush, int dmagic, int drange, int str, int rstr, int mdmg, int prayer, int aspeed) {
        ItemEquipmentStats stats = new ItemEquipmentStats(slot, astab, aslash, acrush, amagic, arange, dstab, dslash, dcrush, dmagic, drange, str, rstr, mdmg, prayer, aspeed);
        wildernessStatsMap.put(itemId, stats);
    }
    ...
    public static ItemEquipmentStats forWildyId(int itemId) {
        if (!wildernessStatsMap.containsKey(itemId)) {
            return forId(itemId).getEquipment();
        }
        return wildernessStatsMap.get(itemId);
    }
