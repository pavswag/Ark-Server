...
import io.kyros.model.items.EquipmentModelType;
...
public class ItemDef {
    ...
    public String getName() {
        if (name == null) {
            return (ItemDefinitionLoader.lookup(getId()).name == null ? "Unknown Item: " + getId() : ItemDefinitionLoader.lookup(getId()).name);
        }
        return name;
    }
    ...
    public boolean isStackable() {
        return stackable || isNoted() || ItemDefinitionLoader.lookup(id).stackable;
    }
