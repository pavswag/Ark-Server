...
public class NpcStats {
    ...
    public static Map<Integer, NpcStats> npcStatsMap = new HashMap<>();

    public static Map<Integer, NpcStats> getNpcStatsMap() {
        return npcStatsMap;
    }
    ...
    public static void addNPCStats(int id, NpcStats stats) {
        npcStatsMap.put(id, stats);
    }
