...
public class BonusApplianceEvent extends Event<Object> {
	...
	public void execute() {
		...
		if (Hespori.ACHIEVE_TIMER > 0 ) {
			Hespori.ACHIEVE_TIMER--;
			if (Hespori.ACHIEVE_TIMER == 1) {
				PlayerHandler.executeGlobalMessage("@bla@[@gre@Hespori@bla@] @red@The Hespori plant is no longer granting 2x Achievement points!");
				new AchieveBonus().deactivate();
			}
		}
		if (Hespori.ENHANCED_ACHIEVE_TIMER > 0 ) {
			Hespori.ENHANCED_ACHIEVE_TIMER--;
			if (Hespori.ENHANCED_ACHIEVE_TIMER == 1) {
				PlayerHandler.executeGlobalMessage("@bla@[@gre@Hespori@bla@] @red@The Enhanced Hespori plant is no longer granting 2x Achievement points!");
				new EnhancedAchieveBonus().deactivate();
			}
		}
		if (Hespori.ENHANCED_DAMAGE_TIMER > 0 ) {
			Hespori.ENHANCED_DAMAGE_TIMER--;
			if (Hespori.ENHANCED_DAMAGE_TIMER == 1) {
				PlayerHandler.executeGlobalMessage("@bla@[@gre@Hespori@bla@] @red@The Enhanced Damage plant is no longer granting 10% Bonus Damage!");
				new DamageBonus().deactivate();
			}
		}
		if (Hespori.KRONOS_TIMER > 0) {
			Hespori.KRONOS_TIMER--;
			if (Hespori.KRONOS_TIMER == 1) {
				PlayerHandler.executeGlobalMessage("@bla@[@gre@Hespori@bla@] @red@The Kronos plant is no longer granting double Raid keys!");
				new KronosBonus().deactivate();
			}
		}
		if (Hespori.ENHANCED_KRONOS_TIMER > 0) {
			Hespori.ENHANCED_KRONOS_TIMER--;
			if (Hespori.ENHANCED_KRONOS_TIMER == 1) {
				PlayerHandler.executeGlobalMessage("@bla@[@gre@Hespori@bla@] @red@The Enhanced Kronos plant is no longer granting double Raid keys!");
				new EnhancedKronosBonus().deactivate();
			}
		}
		...
		if (Hespori.ENHANCED_IASOR_TIMER > 0) {
			Hespori.ENHANCED_IASOR_TIMER--;
			if (Hespori.ENHANCED_IASOR_TIMER == 1) {
				PlayerHandler.executeGlobalMessage("@bla@[@gre@Hespori@bla@] @red@The Enhanced Iasor plant is no longer granting drop rate bonus!");
				new EnhancedIasorBonus().deactivate();
			}
		}
		...
		if (Hespori.ENHANCED_NOXIFER_TIMER > 0) {
			Hespori.ENHANCED_NOXIFER_TIMER--;
			if (Hespori.ENHANCED_NOXIFER_TIMER == 1) {
				PlayerHandler.executeGlobalMessage("@bla@[@gre@Hespori@bla@] @red@The Enhanced Noxifer plant is no longer granting 4x Slayer points!");
				new EnhancedNoxifierBonus().deactivate();
			}
		}
