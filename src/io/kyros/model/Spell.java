...
public enum Spell {
    ...
    WIND_SURGE(23619, SpellBook.MODERN, true),
    WATER_SURGE(23633, SpellBook.MODERN, true),
    EARTH_SURGE(23603, SpellBook.MODERN, true),
    FIRE_SURGE(23583, SpellBook.MODERN, true),
