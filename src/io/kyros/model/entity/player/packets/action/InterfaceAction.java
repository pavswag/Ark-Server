...
import io.kyros.model.world.ClanMember;
...
public class InterfaceAction implements PacketType {
	...
	public void processPacket(Player player, int packetType, int packetSize) {
		...
		Server.getLogging().write(new ReceivedPacketLog(player, packetType, String.format("InterfaceAction id=%d, action=%d", action, id)));
