    ...
    private static void processSpecial(Player player, int specialButtonId) {
        switch(specialButtonId) {
            ...
            case 29113:
                ...
                } else if (player.playerEquipment[Player.playerWeapon] == 4153 || player.playerEquipment[Player.playerWeapon] == 12848 || player.playerEquipment[Player.playerWeapon] == 24225 || player.playerEquipment[Player.playerWeapon] == 24227) {
