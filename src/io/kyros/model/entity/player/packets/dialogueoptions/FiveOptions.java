...
import io.kyros.content.items.RecolourGraceful;
import io.kyros.content.skills.StatReset;
import io.kyros.content.skills.agility.AgilityHandler;
import io.kyros.content.teleportation.TeleportationDevice;
import io.kyros.content.votingincentive.VoteEntriesInstance;
import io.kyros.content.votingincentive.VoteEntryBosses;
...
public class FiveOptions {
	...
	public static void handleOption1(Player c) {
		...
		case 14411:
			...
			break;
		case 14412:
			c.getPA().startTeleport(2625, 3678, 0, "modern", false);//1st option
			c.sendMessage("You will gain XP after completion of each lap");
			c.getPA().closeAllWindows();
			break;
		case 1401:
		...
		case 7287:
			VoteEntriesInstance ve = new VoteEntriesInstance(c, Boundary.VOTE_ENTRY);
			ve.handleEntry(c, ve, VoteEntryBosses.VoteBoss);
			break;

				case 7288:
					VoteEntriesInstance vex = new VoteEntriesInstance(c, Boundary.VOTE_ENTRY);
					vex.handleEntry(c, vex, VoteEntryBosses.BaBa);
					break;
	...
	case 711:
		...
		case 14410:
			...
			break;
		case 14411:
			c.getPA().startTeleport(3351, 2960, 0, "modern", false);//2nd option
			c.sendMessage("You will gain XP after completion of each lap");
			c.getPA().closeAllWindows();
			break;
		case 14412:
		...
		case 2003:
			...
			case 7287:
				VoteEntriesInstance ve = new VoteEntriesInstance(c, Boundary.VOTE_ENTRY);
				ve.handleEntry(c, ve, VoteEntryBosses.DonorBoss);
				break;

			case 7288:
				VoteEntriesInstance vex = new VoteEntriesInstance(c, Boundary.VOTE_ENTRY);
				vex.handleEntry(c, vex, VoteEntryBosses.Manitcore);
				break;
		case 61: // Kbd Lair
	...
	public static void handleOption3(Player c) {
		...
		case 77:
			...
			case 7287:
				VoteEntriesInstance ve = new VoteEntriesInstance(c, Boundary.VOTE_ENTRY);
				ve.handleEntry(c, ve, VoteEntryBosses.Durial);
				break;

			case 7288:
				VoteEntriesInstance vex = new VoteEntriesInstance(c, Boundary.VOTE_ENTRY);
				vex.handleEntry(c, vex, VoteEntryBosses.JavelinColossus);
				break;
	case 711:
	...
	case 193193:
		...
		case 14410:
			...
			break;
		case 14411:
			c.getPA().startTeleport(2672, 3296, 0, "modern", false);//3rd option
			c.sendMessage("You will gain XP after completion of each lap");
			c.getPA().closeAllWindows();
			break;
		case 14412:
	...
	public static void handleOption4(Player c) {
		...
		case 4487:
			...
			case 7287:
				VoteEntriesInstance ve = new VoteEntriesInstance(c, Boundary.VOTE_ENTRY);
				ve.handleEntry(c, ve, VoteEntryBosses.Groot);
				break;

			case 7288:
				VoteEntriesInstance vex = new VoteEntriesInstance(c, Boundary.VOTE_ENTRY);
				vex.handleEntry(c, vex, VoteEntryBosses.NEX);
				break;
		case 851:
	...
	public static void handleOption5(Player c) {
		...
		case 838:
			...
			case 7287:
				c.getDH().sendDialogues(7288, 547);
				break;
			case 7288:
				c.getDH().sendDialogues(7287, 547);
				break;
