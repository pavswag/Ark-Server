...
import io.kyros.model.controller.DefaultController;
...
public class GroupIronman {
     ...
     */
    private static final int MAXIMUM_MEMBERS = 10;
    ...
    public static void moveAfterJoin(Player plr, GroupIronmanGroup group) {
        ...
        if (group != null) {
            text = new String[] {
                    ...
                    "You can join 10 total players, you have " + (10 - group.getJoined()) + " joins left."
            };
        } else {
            text = new String[] {
