...
import io.kyros.model.entity.player.packets.*;
import io.kyros.model.entity.player.packets.action.EnterStringInput;
import io.kyros.model.entity.player.packets.action.InterfaceAction;
import io.kyros.model.entity.player.packets.action.KeyboardShortcutAction;
import io.kyros.model.entity.player.packets.action.ReceiveString;
import io.kyros.model.entity.player.packets.itemoptions.ItemOptionOne;
import io.kyros.model.entity.player.packets.itemoptions.ItemOptionThree;
import io.kyros.model.entity.player.packets.itemoptions.ItemOptionTwo;
...
public class PacketHandler {
	...
	public static void processPacket(Player c, int packetType, int packetSize) {
		...
		if (p == null) {
			...
			//return;
			System.out.println("[PacketHandler] " +c.getDisplayName() + " triggering a Null packet " + packetType + ", " + packetSize);
		}
	...
	static {
		...
		packetId[152] = u;
		packetId[200] = u;
		packetId[250] = new DropDownMenuOptionSelection();
		packetId[85] = new ItemStatRequest();
		packetId[165] = u;
		packetId[238] = u;//Comp Cape
		packetId[150] = u;//Wheel of fortune
		packetId[74] = u;
		packetId[34] = u;
		packetId[68] = u;
		packetId[79] = u;
