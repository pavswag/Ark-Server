...
public class AttackAnimation extends NPCHandler {
	...
	public static int handleEmote(NPC npc) {
		...
		if (NpcDef.forId(npc.getNpcId()).getName().contains("Cow")) {
			return 5849;
		}
		if (npc.getNpcId() >= 3028 && npc.getNpcId() <= 3048) {
			return 6184;
		}


		if (npc.getNpcId() >= 2860 && npc.getNpcId() <= 2864) {
			return 4933;
		}
...
/*		case 8060:
		...
		case 1049:
			...
			case 6611:
			case 6612:
				return Misc.random(1) == 0 ? 9971 : 9973;
			case 8164:
			case 8172:
				return npc.getAttackType() == CombatType.MELEE ? 8056 : 1979;
		case 6610:
			return 9991;
		case 419: // Cockatrice
		case 8781:
