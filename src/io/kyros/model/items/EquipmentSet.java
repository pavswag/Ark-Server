...
public enum EquipmentSet {
    ...
    DRAGONBONE_NECKLACE(new int[][] {{Items.DRAGONBONE_NECKLACE}, {Items.DRAGONBONE_NECKLACE_2}, {Items.BONECRUSHER_NECKLACE}, {Items.BONECRUSHER_NECKLACE_2}}),
    ...
    public static boolean isWearing(Player player, EquipmentSet... sets) {
        return Arrays.stream(sets).allMatch(it -> it.isWearing(player));
    }
