...
public class Configuration {
	...
	public static String SERVER_NAME = "Kyros";
	public static final int PORT_DEFAULT = 52778;
	public static final int PORT_TEST = 43595;

	public static final String PACKAGE = "io.kyros";
	public static final String DATA_FOLDER = "etc";

	public static final String WEBSITE = "https://turmoilrsps.quest";
	public static final String FORUM_TOPIC_URL = "https://Paradise-network.net/";
	public static final String VOTE_LINK = "https://turmoilrsps.quest";
	public static final String HISCORES_LINK = "https://turmoilrsps.net/";
	public static final String STORE_LINK = "https://turmoilrspsnet/";
	public static final String DISCORD_INVITE = "https://discord.gg/turmoilrsps";
	...
	public static int GLOBAL_BOX_COUNT = 500;
	...
	public static final boolean PROXY_SERVER = false;
	public static final boolean LOWERCASE_CAPTCHA = true;
	public static boolean DISABLE_DATABASES = true;
	public static boolean DISABLE_DISCORD_MESSAGING = true;
	public static boolean BOGOF = false;
	public static boolean DISABLE_CONNECTION_REQUEST_LIMIT = false;
	public static boolean DISABLE_DUPE_WARDEN = false;
	public static boolean DISABLE_BLACKJACK = true;
	...
	public static boolean DISABLE_TRADING_POST = false;
	...
	public static boolean DISABLE_DISPLAY_NAMES = true;
	...
	public static boolean CASTLEWARS_EVENT = false;

	public static String TOWN_CRIER = "Server has been released!";
	 ...
	 */
	public static final int MAX_PLAYERS = 3500;
	...
	public static final int[] UNDEAD_NPCS = {
			...
			879,2999,2993,4421,3969,3970,3971,8059,8058,8059,8060,8061,4500,4505,882,5353,5354,5355,3616,547,1163,8359,6611,
			...
			6462,6463,6464,6465,6466,6467,6468,6596,6597,6598,6741, Npcs.SKELETON_HELLHOUND, 8059, 8058, 8060, 7413, Npcs.PESTILENT_BLOAT, 10812, 10813,
	...
	public static boolean BONUS_PC;
	 ...
	 */
	public static final int START_LOCATION_X = 1758;
	public static final int START_LOCATION_Y = 3598;
	 ...
	 */
	public static final int RESPAWN_X = START_LOCATION_X;
	public static final int RESPAWN_Y = START_LOCATION_Y;
	 ...
	 * Glory locations.
	 */
	public static final int EDGEVILLE_X = 3101;
	public static final int EDGEVILLE_Y = 3497;
