...
import io.kyros.content.boosts.other.GenericBoost;
import io.kyros.content.boosts.xp.ExperienceBooster;
...
public class Boosts {
    ...
    public static void init() {
        ...
        Reflections reflections = new Reflections("io.kyros.content.boosts", new SubTypesScanner());
