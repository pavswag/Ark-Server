    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            ...
            case 2:
                ...
                break;
            case 3:
                lines.add("Jossik was happy I destroyed that creature!.");
                lines.add("there's still more of creatures in the basement.");
                lines.add("He said he would trade any caskets");
                lines.add("I get from killing the creatures");
