...
public class MonkeyMadnessQuest extends Quest {
    ...
    public List<String> getJournalText(int stage) {
        ...
        switch (stage) {
            ...
            case 4:
                ...
                break;
            case 5:
                lines.add("I slayed the demon for King Narnode!");
                lines.add("I have been rewarded with");
                lines.add("Access to dragon scimitar shop.");
                lines.add("Experience lamp x 2.");
                lines.add("500k MadPoints.");
                break;
        }
        return lines;
    }
    ...
    public List<String> getCompletedRewardsList() {
        return Lists.newArrayList("Access to the King's shop.", "2 Experience Lamps.", "500k MadPoints");
    }

    @Override
    public void giveQuestCompletionRewards() {
        player.getItems().addItemUnderAnyCircumstance(696, 2);
