...
public class JarsToPoints {
    ...
    public static final int FOE_POINTS = 10000;
    ...
    public static boolean open(Player c, int item) {
        ...
        if (jar.isPresent()) {
            ...
            c.start(new DialogueBuilder(c)
                .itemStatement(id, "Would you like to convert this jar to " + BOSS_POINTS + " Boss points?", "You can also burn it in the Foundry.")
                .option(
