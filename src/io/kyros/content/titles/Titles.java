...
public class Titles {
	 ...
	 */
	private final List<Title> purchased = new ArrayList<>();

	/**
	 * A mapping that contains a title for each slot.
	 */
	private final Map<TitleMenuSlot, Title> titles = new HashMap<>();
	...
	private void view(Title title) {
		...
		if (title.equals(Title.CUSTOM)) {
			...
			player.getPA().sendInterfaceHidden(1, 53530);
			player.getPA().sendInterfaceHidden(0, 53535);
		} else {
			player.getPA().sendString(title.getName(), 53531);
			player.getPA().sendInterfaceHidden(0, 53530);
			player.getPA().sendInterfaceHidden(1, 53535);
		}
	...
	private void select(Title title) {
		...
		if (title.equals(Title.CUSTOM)) {
			...
			String normalizedTitle = temporaryCustomTitle.toLowerCase().replaceAll("4", "a")
					.replaceAll("3", "e")
					.replaceAll("6", "g")
					.replaceAll("9", "g")
					.replaceAll("1", "i")
					.replaceAll("7", "l")  // Assuming `L` can be confused with `7`
					.replaceAll("0", "o")
					.replaceAll("5", "s")
					.replaceAll("7", "t")
					.replaceAll("2", "z");

			if (normalizedTitle.equalsIgnoreCase("admin") ||
					normalizedTitle.equalsIgnoreCase("administrator") ||
					normalizedTitle.equalsIgnoreCase("mod") ||
					normalizedTitle.equalsIgnoreCase("moderator") ||
					normalizedTitle.equalsIgnoreCase("owner") ||
					normalizedTitle.equalsIgnoreCase("support") ||
					normalizedTitle.equalsIgnoreCase("staff") ||
					normalizedTitle.equalsIgnoreCase("developer") ||
					normalizedTitle.equalsIgnoreCase("dev") ||
					normalizedTitle.equalsIgnoreCase("manager") ||
					normalizedTitle.equalsIgnoreCase("lead") ||
					normalizedTitle.equalsIgnoreCase("founder") ||
					normalizedTitle.equalsIgnoreCase("ceo") ||
					normalizedTitle.equalsIgnoreCase("cto") ||
					normalizedTitle.equalsIgnoreCase("cfo") ||
					normalizedTitle.equalsIgnoreCase("team")) {
