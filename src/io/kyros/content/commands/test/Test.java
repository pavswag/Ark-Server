...
import io.kyros.content.items.MaxCapeCombinations;
import io.kyros.content.itemskeptondeath.modifiers.AlwaysKeptDeathItem;
	...
	public void execute(Player player, String commandName, String input) {
		switch (input) {
			...
			case "skillset":
				...
				break;
		case "tobroll":
			TheatreOfBloodChest.rewardItems(player, TheatreOfBloodChest.getRandomItems(player, 5));
			break;
		case "tob":
		...
		case "pk":
			...
			Server.getPlayers().nonNullStream().filter(Objects::nonNull).forEach(a -> {
