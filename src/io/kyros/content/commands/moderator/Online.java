...
public class Online extends Command {
	...
	public void execute(Player c, String commandName, String input) {
		List<Player> matches = Server.getPlayers().nonNullStream().filter(player -> player.connectedFrom.equalsIgnoreCase(input) || player.getMacAddress().equalsIgnoreCase(input))
