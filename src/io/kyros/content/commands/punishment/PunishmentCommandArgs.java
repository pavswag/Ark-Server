package io.kyros.content.commands.punishment;
...
import static io.kyros.content.commands.punishment.PunishmentCommand.SEPARATOR;
...
public class PunishmentCommandArgs {
    ...
    public Player getPlayerForDisplayName() {
        ...
        Preconditions.checkArgument(other.getRights().isNot(Right.GAME_DEVELOPER), "can't punish owner");
        return other;
    }
