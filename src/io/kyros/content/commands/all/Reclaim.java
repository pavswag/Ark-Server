...
import io.kyros.sql.donation.reclaim.ReclaimDonationResponse;
import io.kyros.sql.donation.reclaim.ReclaimQuery;
import io.kyros.util.Misc;
import io.kyros.util.logging.player.ReclaimDonationLog;
...
public class Reclaim extends Command {
	...
	public void execute(Player player, String commandName, String input) {
		boolean skipAuth = player.getRights().contains(Right.STAFF_MANAGER);
	...
	public Optional<String> getDescription() {
		return Optional.of("Reclaim donations from ArkCane v1 between ");
	}
}
