...
import io.kyros.content.items.item_combinations.ArcaneSpiritShield;
import io.kyros.content.items.item_combinations.BalanceBook;
import io.kyros.content.items.item_combinations.BlessedSpiritShield;
import io.kyros.content.items.item_combinations.ElysianSpiritShield;
import io.kyros.content.items.item_combinations.EternalBoots;
import io.kyros.content.items.item_combinations.HolyBook;
import io.kyros.content.items.item_combinations.InfernalAxe;
import io.kyros.content.items.item_combinations.InfernalPickaxe;
import io.kyros.content.items.item_combinations.PegasianBoots;
import io.kyros.content.items.item_combinations.PrimordialBoots;
import io.kyros.content.items.item_combinations.RingOfWealthImbued;
import io.kyros.content.items.item_combinations.SaradominsBlessedSword;
import io.kyros.content.items.item_combinations.SpectralSpiritShield;
import io.kyros.content.items.item_combinations.TentacleWhip;
import io.kyros.content.items.item_combinations.UnholyBook;
import io.kyros.content.items.item_combinations.InfernalHarpoon;
...
public enum ItemCombinations {
	...
	INFERNAL_HARPOON(new InfernalHarpoon(new GameItem(21031), Optional.empty(), new GameItem[] { new GameItem(13233), new GameItem(21028) })),
