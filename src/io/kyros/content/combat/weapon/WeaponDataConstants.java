...
public class WeaponDataConstants {
    ...
    public static final int[] SPEARS = {
            ...
            25979, 27291, 25981, 27287, 33204, 33432,
            // Hasta
    ...
    public static final int[] SLASH_SWORDS = {
            // Scimitars
            Items.DRAGON_SCIMITAR, Items.DRAGON_SCIMITAR_OR, 33147, Items.BRONZE_SCIMITAR, Items.IRON_SCIMITAR,
            ...
            Items.MACHETE, // ...
            Items.BLADE_OF_SAELDOR, 27690, 22331, 28531,
    ...
    public static final int[] CRUSH_SWORDS = {
            ...
            Items.DRAGON_2H_SWORD, Items.ARMADYL_GODSWORD, 20164, Items.SARADOMIN_GODSWORD, Items.ZAMORAK_GODSWORD, Items.BANDOS_GODSWORD,
            Items.ARMADYL_GODSWORD_OR, Items.SARADOMIN_GODSWORD_OR, Items.ZAMORAK_GODSWORD_OR, Items.BANDOS_GODSWORD_OR,
            Items.SARADOMIN_SWORD, Items.SARADOMINS_BLESSED_SWORD, Items.SHADOW_SWORD, Items.SPATULA, Items.GILDED_2H_SWORD, 26233, 28537, 33430, 33202
    };
    ...
    public static final int[] SCYTHE = {
            Items.SCYTHE, Items.SCYTHE_OF_VITUR, 25736, 25739, 33161, 33148, 33184, 33203, 28543,33431
    };
    ...
    public static final int[] STAB_SWORDS = {
            ...
            Items.ANGER_SWORD, Items.TRAINING_SWORD, Items.WOODEN_SWORD, Items.SPORK, Items.RAPIER, Items.GHRAZI_RAPIER, 25734, Items.TOKTZ_XIL_AK, Items.LEAF_BLADED_SWORD,
            Items.WILDERNESS_SWORD_1, Items.WILDERNESS_SWORD_2, Items.WILDERNESS_SWORD_3, Items.WILDERNESS_SWORD_4,  33329
    };
    ...
    public static final int[] MACES = {
            ...
            Items.ANGER_MACE, Items.ANCIENT_MACE, Items.ROLLING_PIN, Items.TZHAAR_KET_EM, 27657, 27660,
    ...
    public static final int[] WARHAMMERS = {
            ...
            Items.GRANITE_MAUL, Items.GRANITE_MAUL_OR, 24225, 24227, 33175, 27580, 27586, 28338, 21015, 28682, 27100, 4718
    };

    // [[accurate, slash], [shared, slash], [defensive, slash]]
    public static final int[] WHIPS = {
            Items.ABYSSAL_WHIP, Items.FROZEN_ABYSSAL_WHIP, Items.VOLCANIC_ABYSSAL_WHIP, Items.ABYSSAL_TENTACLE, 26484, 26482, 33162
    };
    ...
    public static final int[] AXES = {
            ...
            Items.BLESSED_AXE, Items.GILDED_AXE, Items.THIRD_AGE_AXE, Items.INFERNAL_AXE, Items.CRYSTAL_AXE, Items.DRAGON_HARPOON, 25378, 25376, 25373
    };
    ...
    public static final int[] STANDARD_STAFFS = {
            ...
            Items.SMOKE_BATTLESTAFF, 27624, 27679, 22335,
            ...
            Items.TRIDENT_OF_THE_SEAS, Items.TRIDENT_OF_THE_SWAMP, Items.SANGUINESTI_STAFF, 25731, 33149, 33205, 28796, 21198, Items.DAWNBRINGER, Items.STAFF_OF_LIGHT, 33433, 84,
            ...
            Items.IBANS_STAFF, Items.IBANS_STAFF_U, Items.ZURIELS_STAFF,29594,
    };
    ...
    public static final int[] CLAWS = {
            ...
            Items.DRAGON_CLAWS, 26708, Items.BEACH_BOXING_GLOVES, Items.BOXING_GLOVES, 28534, 29084, 33417,
    };
    ...
    public static final int[] HALBERDS = {
            ...
            Items.RUNE_HALBERD, Items.DRAGON_HALBERD, Items.CRYSTAL_HALBERD, 29796
    };
    ...
    public static final int[] BOWS = {
            ...
            Items.BLURITE_CROSSBOW, 26374, 33206, 25916, 25918, 26486, 8880, 26269, 33435,
            //Special Crossbows
            ...
            //Special Bows
            Items.CURSED_GOBLIN_BOW, Items.TRAINING_BOW, Items.OGRE_BOW, Items.DARK_BOW, Items.CRYSTAL_BOW, Items.TWISTED_BOW,33160, Items.CRAWS_BOW,
            Items.DARK_BOW_BLUE, Items.DARK_BOW_GREEN,Items.DARK_BOW_YELLOW,Items.DARK_BOW_WHITE, Items.THIRD_AGE_BOW, 28540,
            // Crystal bows
            412, 4213, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221, 4222, 4223,
            // bofa
            25865, 25867, 25884, 25888, 25886, 25890, 25892, 25894, 25896, 33058, 33207,27655, 29599, 33434,
            //corrupted bow
            23855, 23857, 23902,
            //new wildy weapons
            27655, 27610, 22333
    ...
    public static final int[] THROWN = {
            ...
            //Darts
            Items.BRONZE_DART, Items.IRON_DART, Items.STEEL_DART, Items.BLACK_DART, Items.MITHRIL_DART, Items.ADAMANT_DART, Items.RUNE_DART, Items.DRAGON_DART, Items.SNOWBALL,
            //Thrownaxe
            ...
            //Special Thrown
            Items.TOKTZ_XIL_UL, Items.CHINCHOMPA_2, Items.RED_CHINCHOMPA_2, Items.BLACK_CHINCHOMPA, Items.TOXIC_BLOWPIPE, 28688, 28919, 28922
