...
public class NPCAutoAttackBuilder {
    ...
    public NPCAutoAttackBuilder setMinHit(int minHit) {
        this.minHit = minHit;
        return this;
    }
    ...
    public NPCAutoAttack createNPCAutoAttack() {
        return new NPCAutoAttack(animation, projectile, startGraphic, endGraphic, combatType, hitDelay, attackDelay, minHit, maxHit, poisonDamage,
