...
public class Damage {
	 ...
	 * @param hitMask the type of hitmark that is displayed
	 * @param combatType the special attack
	 */
	public Damage(Entity target, int amount, int ticks, int[] equipment, HitMask hitMask, CombatType combatType) {
		this(amount);
		if (ticks < 0) {
	 ...
	 * @param hitMask the type of hitmark that is displayed
	 */
	public Damage(Entity target, int amount, int ticks, int[] equipment, HitMask hitMask, CombatType combatType, RangedWeaponType rangedWeaponType,
                  Special special, boolean success) {
		this(target, amount, ticks, equipment, hitMask, combatType);
