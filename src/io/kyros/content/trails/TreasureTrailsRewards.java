...
//		add(new TreasureTrailsRewardItem(Items.COINS, 2500, 50000, RewardRarity.COMMON), RewardLevel.SHARED);
		...
		add(new TreasureTrailsRewardItem(691, 1, 1, RewardRarity.RARE), RewardLevel.MEDIUM);
		...
		add(new TreasureTrailsRewardItem(693, 1, 1, RewardRarity.VERY_RARE), RewardLevel.HARD);
		...
		add(new TreasureTrailsRewardItem(696, 1, 1, RewardRarity.VERY_RARE), RewardLevel.MASTER);
	}
}
