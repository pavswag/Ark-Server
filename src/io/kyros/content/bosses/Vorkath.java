...
//			{ 21488, 1 }, { 1392, 5 + Misc.random(10) }, { 5316, 1 }, { 5317, 1 }, { 5289, 1 }, { 5315, 1 } };
	...
	public static final int[] NPC_IDS = {8059, 8058, 8060};
	...
	public static void poke(Player player, NPC npc) {
		...
		npc.requestTransform(8058);
		CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
			@Override
			public void execute(CycleEventContainer container) {
				npc.requestTransform(8060);
			}
	...
	public static void spawn(Player player) {
		NPCSpawning.spawnNpc(player, 8059, SPAWN.getX(), SPAWN.getY(), player.getIndex() * 4, 0,
