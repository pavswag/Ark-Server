...
import io.kyros.content.bosses.zulrah.impl.CreateToxicStageOne;
import io.kyros.content.bosses.zulrah.impl.MageStageEight;
import io.kyros.content.bosses.zulrah.impl.MageStageFive;
import io.kyros.content.bosses.zulrah.impl.MageStageThree;
import io.kyros.content.bosses.zulrah.impl.MeleeStageSix;
import io.kyros.content.bosses.zulrah.impl.MeleeStageTen;
import io.kyros.content.bosses.zulrah.impl.MeleeStageTwo;
import io.kyros.content.bosses.zulrah.impl.RangeStageEleven;
import io.kyros.content.bosses.zulrah.impl.RangeStageFour;
import io.kyros.content.bosses.zulrah.impl.RangeStageNine;
import io.kyros.content.bosses.zulrah.impl.RangeStageSeven;
import io.kyros.content.bosses.zulrah.impl.SpawnZulrahStageZero;
import io.kyros.content.commands.owner.Object;
...
public class Zulrah {
	...
	public void stop() {
		...
		for (DangerousLocation value : DangerousLocation.values()) {
			for (Point point : value.getPoints()) {
				Server.getGlobalObjects().remove(TOXIC_SMOKE, point.x, point.y, zulrahInstance.getHeight(), zulrahInstance);
			}
		}
	}
