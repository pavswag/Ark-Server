package io.kyros.content.bosses.hydra;
    ...
    private void projectileDamage() {
        ...
        CycleEventHandler.getSingleton().addEvent(npc, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
                ...
                player.appendDamage(npc, damage, (damage > 0 ? HitMask.HIT : HitMask.MISS));
        ...
        CycleEventHandler.getSingleton().addEvent(npc, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
                ...
                if (tick == 0) {
                    ...
                    Iterator<Location> lightning = steps.iterator();
                    while(lightning.hasNext()) {
                        Location loc = lightning.next();
                        ...
                        if (player.getLocation().equalsIgnoreHeight(loc)) {
                            ...
                            player.appendDamage(npc, Misc.random(5, 13), HitMask.HIT);
                            lightning.remove();
                        }
                    }
                } else if (tick >= 15) {
        ...
        CycleEventHandler.getSingleton().addEvent(2, npc, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
                ...
                if (!spawnedFire.isEmpty()) {
                    ...
                    if (inFire) {
                        player.appendDamage(npc, Misc.random(1, 13), HitMask.HIT);
                    }
                }
                if (tick == 0) {
                    npc.facePlayer(player.getIndex());
        ...
        CycleEventHandler.getSingleton().addEvent(1, npc, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
                ...
                if (Boundary.isIn(player, fireZones[0], (tick >= 10 ? fireZones[1] : Boundary.EMPTY)) && tick >= 4 && tick <= 60) {
                    player.appendDamage(npc, Misc.random(1, 20), HitMask.HIT);
                }
                tick++;
            }
            ...
            CycleEventHandler.getSingleton().addEvent(npc, new CycleEvent() {
                ...
                public void execute(CycleEventContainer container) {
                    ...
                    if (tick >= 3) {
                        ...
                        if (targetInLocation) {
                            player.appendDamage(npc, Misc.random(1, 12), HitMask.HIT);
