...
import io.kyros.model.entity.player.Potions;
            ...
            CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
                ...
                public void execute(CycleEventContainer container) {
                    ...
                    if (System.currentTimeMillis() - Potions.getSanfewTime(player) >= 16_000) {
                        ...
                        player.appendDamage(nightmare, 40 + Misc.trueRand(16), HitMask.HIT);
                    } else {
                        player.sendMessage("<col=355D27>The parasite within you has been weakened.");
                        player.appendDamage(nightmare, 4 + Misc.trueRand(5), HitMask.HIT);
                    }
                    container.stop();
                }
            }, 12);
