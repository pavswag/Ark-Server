...
public class NpcDialogue extends DialogueObject {
    ...
    public void send(Player player) {
        ...
        player.getPA().sendInterfaceAnimation(headChildId, expression == null ? DialogueExpression.SPEAKING_CALMLY.getAnimation() : expression.getAnimation());
