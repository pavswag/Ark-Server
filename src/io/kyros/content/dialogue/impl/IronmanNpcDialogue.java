...
import io.kyros.model.entity.player.mode.ModeRevertType;
...
import static io.kyros.model.entity.player.Right.IRONMAN;
import static io.kyros.model.entity.player.Right.PLAYER;
import static io.kyros.model.entity.player.Right.ROGUE;
...
public class IronmanNpcDialogue extends DialogueBuilder {
    ...
    static {
        ...
        SWITCHES.put(Mode.forType(ModeType.IRON_MAN), EnumSet.of(PLAYER));
        SWITCHES.put(Mode.forType(ModeType.HC_IRON_MAN), EnumSet.of(PLAYER, IRONMAN));
        SWITCHES.put(Mode.forType(ModeType.GROUP_IRONMAN), EnumSet.of(PLAYER, IRONMAN));
