...
public class CannonRepository {
    private static final Logger logger = LoggerFactory.getLogger(io.kyros.content.dwarfleaguecannon.Cannon.class);
    private static final Map<Position, io.kyros.content.dwarfleaguecannon.Cannon> CANNON_MAP = new HashMap<>();

    public static boolean add(io.kyros.content.dwarfleaguecannon.Cannon cannon) {
