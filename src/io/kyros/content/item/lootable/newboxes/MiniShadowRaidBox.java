...
public class MiniShadowRaidBox extends MysteryBoxLootableNew {
...
public static void loadItems() {
        ...
        YamlLoader.LoadedBox loadedBox = YamlLoader.loadItems("MiniShadowRaidBox");
...
rates = loadedBox.getRates();
     ...
     */
    public MiniShadowRaidBox(Player player) {
        super(player);
    }
