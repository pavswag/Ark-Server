...
public class ShadowRaidBox extends MysteryBoxLootableNew {
...
public static void loadItems() {
        ...
        YamlLoader.LoadedBox loadedBox = YamlLoader.loadItems("ShadowRaidBox");
...
rates = loadedBox.getRates();
     ...
     */
    public ShadowRaidBox(Player player) {
        super(player);
    }
