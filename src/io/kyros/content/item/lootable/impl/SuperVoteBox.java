...
public class SuperVoteBox extends MysteryBoxLootableNew {
...
public static void loadItems() {
        ...
        YamlLoader.LoadedBox loadedBox = YamlLoader.loadItems("SuperVoteBox");
...
rates = loadedBox.getRates();
     ...
     */
    public SuperVoteBox(Player player) {
        super(player);
    }
