...
import io.kyros.sql.wogw.GetRecentContributionsSqlQuery;
import io.kyros.sql.wogw.GetTopContributionsSqlQuery;
    ...
    public void open() {
        ...
        Server.getDatabaseManager().exec((context, connection) -> {
            ...
            player.addQueuedAction(plr -> {
                updateConfig();
//                player.sendMessage("@cr10@ You may also use your Foundry Point Certificates on the WoGW!");
