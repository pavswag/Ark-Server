...
public final class DesertAchievementDiary extends StatefulAchievementDiary<DesertDiaryEntry> {
	...
	public static final Set<DesertDiaryEntry> EASY_TASKS = EnumSet.of(DesertDiaryEntry.PASS_GATE, DesertDiaryEntry.CUT_CACTUS, DesertDiaryEntry.KILL_SNAKES_DESERT, DesertDiaryEntry.KILL_LIZARDS_DESERT, DesertDiaryEntry.MINE_CLAY);
	
	public static final Set<DesertDiaryEntry> MEDIUM_TASKS = EnumSet.of(DesertDiaryEntry.KILL_BANDIT, DesertDiaryEntry.PASS_GATE_ROBES, DesertDiaryEntry.COMBAT_POTION, DesertDiaryEntry.CHOP_TEAK, DesertDiaryEntry.PICKPOCKET_THUG, DesertDiaryEntry.TRAVEL_NARDAH, DesertDiaryEntry.KILL_VULTURE);
	
	public static final Set<DesertDiaryEntry> HARD_TASKS = EnumSet.of(DesertDiaryEntry.TRAVEL_POLLNIVNEACH, DesertDiaryEntry.KILL_DUST_DEVIL);
	
	public static final Set<DesertDiaryEntry> ELITE_TASKS = EnumSet.of(DesertDiaryEntry.PRAY_SOPHANEM);
	...
	public final void display() {
		...
		player.getPA().sendFrame126("@red@Desert Diary", 8144);
