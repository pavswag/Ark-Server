package io.kyros.content.minigames.warriors_guild;
...
public class WarriorsGuild {
	...
	public static final Boundary[] WAITING_ROOM_BOUNDARY = { new Boundary(2838, 3536, 2846, 3542, 2), new Boundary(2847, 3537, 2847, 3537, 2) };
