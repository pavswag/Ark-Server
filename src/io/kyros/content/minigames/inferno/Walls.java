...
import static io.kyros.content.minigames.inferno.Inferno.reset;
    ...
    public void walls(Player player, Inferno ctx, int[][] type) {
        CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
            ...
            public void execute(CycleEventContainer container) {
                ...
                if (ctx.started) {
                    if (ticks == 0) {
                        nib1 = NPCSpawning.spawnNpcOld(player, InfernoWaveData.JAL_NIB, 2272, 5339, ctx.getHeight(), 0, InfernoWaveData.getHp(InfernoWaveData.JAL_NIB), InfernoWaveData.getMax(InfernoWaveData.JAL_NIB), InfernoWaveData.getAtk(InfernoWaveData.JAL_NIB), InfernoWaveData.getDef(InfernoWaveData.JAL_NIB), false, false);
                        nib2 = NPCSpawning.spawnNpcOld(player, InfernoWaveData.JAL_NIB, 2273, 5339, ctx.getHeight(), 0, InfernoWaveData.getHp(InfernoWaveData.JAL_NIB), InfernoWaveData.getMax(InfernoWaveData.JAL_NIB), InfernoWaveData.getAtk(InfernoWaveData.JAL_NIB), InfernoWaveData.getDef(InfernoWaveData.JAL_NIB), false, false);
                        nib3 = NPCSpawning.spawnNpcOld(player, InfernoWaveData.JAL_NIB, 2274, 5339, ctx.getHeight(), 0, InfernoWaveData.getHp(InfernoWaveData.JAL_NIB), InfernoWaveData.getMax(InfernoWaveData.JAL_NIB), InfernoWaveData.getAtk(InfernoWaveData.JAL_NIB), InfernoWaveData.getDef(InfernoWaveData.JAL_NIB), false, false);
                        ctx.add(nib1);
                        ctx.add(nib2);
                        ctx.add(nib3);
                    }
                            ...
                            if (ticks % 4 == 0) {
                                if (!nib1.isDead()) {
                                    if (wall1.getDistance(nib1.getX(), nib1.getY()) <= 1) {
                                        ...
                                        wall1Hp -= amount;
                                        if (amount == 0) {
                                            wall1.appendDamage(nib1, amount, HitMask.MISS);
                                        } else {
                                            wall1.appendDamage(nib1, amount, HitMask.HIT);
                                        }
                                    }
                                }
                                if (!nib2.isDead()) {
                                    if (wall1.getDistance(nib2.getX(), nib2.getY()) <= 1) {
                                        ...
                                        wall1Hp -= amount;
                                        if (amount == 0) {
                                            wall1.appendDamage(nib2, amount, HitMask.MISS);
                                        } else {
                                            wall1.appendDamage(nib2, amount, HitMask.HIT);
                                        }
                                    }
                                }
                                if (!nib3.isDead()) {
                                    if (wall1.getDistance(nib3.getX(), nib3.getY()) <= 1) {
                                        ...
                                        wall1Hp -= amount;
                                        if (amount == 0) {
                                            wall1.appendDamage(nib3, amount, HitMask.MISS);
                                        } else {
                                            wall1.appendDamage(nib3, amount, HitMask.HIT);
                                        }
                                    }
                                }
                            }
                            ...
                            if (ticks % 4 == 0) {
                                if (!nib1.isDead()) {
                                    if (wall2.getDistance(nib1.getX(), nib1.getY()) <= 1) {
                                        ...
                                        wall2Hp -= amount;
                                        if (amount == 0) {
                                            wall2.appendDamage(nib1, amount, HitMask.MISS);
                                        } else {
                                            wall2.appendDamage(nib1, amount, HitMask.HIT);
                                        }
                                    }
                                }
                                if (!nib2.isDead()) {
                                    if (wall2.getDistance(nib2.getX(), nib2.getY()) <= 1) {
                                        ...
                                        wall2Hp -= amount;
                                        if (amount == 0) {
                                            wall2.appendDamage(nib2, amount, HitMask.MISS);
                                        } else {
                                            wall2.appendDamage(nib2, amount, HitMask.HIT);
                                        }
                                    }
                                }
                                if (!nib3.isDead()) {
                                    if (wall2.getDistance(nib3.getX(), nib3.getY()) <= 1) {
                                        ...
                                        wall2Hp -= amount;
                                        if (amount == 0) {
                                            wall2.appendDamage(nib3, amount, HitMask.MISS);
                                        } else {
                                            wall2.appendDamage(nib3, amount, HitMask.HIT);
                                        }
                                    }
                                }
                            }
                            ...
                            if (ticks % 4 == 0) {
                                if (!nib1.isDead()) {
                                    if (wall3.getDistance(nib1.getX(), nib1.getY()) <= 1) {
                                        ...
                                        wall3Hp -= amount;
                                        if (amount == 0) {
                                            wall3.appendDamage(nib1, amount, HitMask.MISS);
                                        } else {
                                            wall3.appendDamage(nib1, amount, HitMask.HIT);
                                        }
                                    }
                                }
                                if (!nib2.isDead()) {
                                    if (wall3.getDistance(nib2.getX(), nib2.getY()) <= 1) {
                                        ...
                                        wall3Hp -= amount;
                                        if (amount == 0) {
                                            wall3.appendDamage(nib2, amount, HitMask.MISS);
                                        } else {
                                            wall3.appendDamage(nib2, amount, HitMask.HIT);
                                        }
                                    }
                                }
                                if (!nib3.isDead()) {
                                    if (wall3.getDistance(nib3.getX(), nib3.getY()) <= 1) {
                                        ...
                                        wall3Hp -= amount;
                                        if (amount == 0) {
                                            wall3.appendDamage(nib3, amount, HitMask.MISS);
                                        } else {
                                            wall3.appendDamage(nib3, amount, HitMask.HIT);
                                        }
                                    }
                                }
                            }
                            ...
                            if (!nib1.isDead()) {
                                ...
                                if (ticks % 4 == 0) {
                                    if (nib1.getDistance(player.getX(), player.getY()) <= 1) {
                                        ...
                                        if (amount == 0) {
                                            player.appendDamage(nib1, amount, HitMask.MISS);
                                        } else {
                                            player.appendDamage(nib1, amount, HitMask.HIT);
                                        }
                                    }
                                }
                            }
                            if (!nib2.isDead()) {
                                ...
                                if (ticks % 4 == 0) {
                                    if (nib2.getDistance(player.getX(), player.getY()) <= 1) {
                                        ...
                                        if (amount == 0) {
                                            player.appendDamage(nib2, amount, HitMask.MISS);
                                        } else {
                                            player.appendDamage(nib2, amount, HitMask.HIT);
                                        }
                                    }
                                }
                            }
                            if (!nib3.isDead()) {
                                ...
                                if (ticks % 4 == 0) {
                                    if (nib3.getDistance(player.getX(), player.getY()) <= 1) {
                                        ...
                                        if (amount == 0) {
                                            player.appendDamage(nib3, amount, HitMask.MISS);
                                        } else {
                                            player.appendDamage(nib3, amount, HitMask.HIT);
                                        }
                                    }
                                }
                            }
