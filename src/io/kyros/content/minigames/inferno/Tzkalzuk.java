                            ...
                            public void execute(CycleEventContainer container) {
                                ...
                                if (ticks == 3) {
                                    ...
                                    if (Misc.random(500) + 200 > Misc.random(MagicMaxHit.mageDefence(player))) {
                                        if (amount == 0) {
                                            player.appendDamage(tzkal, amount, HitMask.MISS);
                                        } else {
                                            player.appendDamage(tzkal, amount, HitMask.HIT);
                                        }
                                    } else {
                                        player.appendDamage(tzkal, 0, HitMask.MISS);
                                    }
                                    container.stop();
                                }
                                ticks++;
            ...
            private void healOrAttack(NPC npc) {
                ...
                CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
                    ...
                    public void execute(CycleEventContainer container) {
                        ...
                        if (tick == 2) {
                            if (attack) {
                                player.appendDamage(npc, 1 + Misc.random(0, 2), HitMask.HIT);
                            } else {
                                        ...
                                        if (jad.lastDamageTaken > 0 || player.getInferno().glyph.isDead()) {
                                            ...
                                            if (type == 0) {
                                                ...
                                                if (Misc.random(500) + 200 > Misc.random(RangeMaxHit.calculateRangeDefence(player))) {
                                                    if (amount == 0) {
                                                        player.appendDamage(jad, amount, HitMask.MISS);
                                                    } else {
                                                        player.appendDamage(jad, amount, HitMask.HIT);
                                                    }
                                                } else {
                                                    player.appendDamage(jad, 0, HitMask.MISS);
                                                }
                                            } else {
                                                if (player.protectingMagic()) {
                                                    amount = 0;
                                            ...
                                            if (amount == 0) {
                                                player.getInferno().glyph.appendDamage(jad, amount, HitMask.MISS);
                                            } else {
                                                player.getInferno().glyph.appendDamage(jad, amount, HitMask.HIT);
                                            }
                                        }
                                    }
                                }
