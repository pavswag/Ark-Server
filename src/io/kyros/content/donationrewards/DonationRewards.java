package io.kyros.content.donationrewards;
...
import io.kyros.util.SundayReset;
...
public class DonationRewards {
    ...
    private static final String TEXT_COLOUR = "<col=205209>@cr1@";
    ...
    public void increaseDonationAmount(int amount) {
        if (amount > 0) {
            ...
            if (amountDonatedThisWeek >= 500) {
                setAmountDonatedThisWeek(0);
                player.sendErrorMessage("Due to your efforts your weekly donation has been reset earlier!");
            }
        }
    }
