package io.kyros.content.event.eventcalendar;

import com.google.common.base.Preconditions;
import io.kyros.Server;
import io.kyros.ServerState;
import io.kyros.model.entity.player.Player;
import io.kyros.model.entity.player.Right;
import io.kyros.sql.eventcalendar.queries.*;
...
public class EventCalendar {
     ...
     */
    public static final String EVENT_NAME = "September Event";
    ...
    public static final String LOGIN_MESSAGE = MESSAGE_COLOUR + "The " + EVENT_NAME + " is in progress! 30 chances to win! @red@::cal";
    ...
    private static final String RULES_BUTTON_URL = "https://discord.gg/kyrosx";
    ...
    public static boolean isEventRunning(LocalDate localDate) {
        return localDate.getMonth() == MONTH && getChallenge(localDate) != null && localDate.getYear() == 2021;
    }
