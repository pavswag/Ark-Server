...
public class Sounds {
    ...
    private static final int DEFAULT_EQUIP_SOUND = 2244;

    private static final SoundId[] EQUIP_ITEM_SOUNDS = {
            // Equipment
/*            new SoundId(2241, "d'hide"),
            new SoundId(2239, "chainbody", "platebody"),
            new SoundId(2440, "helm"), //TODO Find all new equipment sounds
            new SoundId(2442, "platelegs", "plateskirt"),
            new SoundId(2237, "boots"),*/
            new SoundId(2248, "sword", "scimitar", "mace", "flail", "axe", "pickaxe", "battleaxe", "greataxe", "voidwaker"),
            new SoundId(2247, "staff", "spear", "hasta", "lance", "sceptre"),
            new SoundId(2244, "bow", "blowpipe", "arrow"),

            new SoundId(1080, "whip"),
