package io.kyros.content.skills.hunter.trap.impl;
...
public final class BirdSnare extends Trap {
	...
	public enum BirdData {
		CRIMSON_SWIFT(5549, 9373, 1, 134, 10, new GameItem(526), new GameItem(10088), new GameItem(9978)),
		GOLDEN_WARBLER(5551, 9377, 5, 147, 12, new GameItem(526), new GameItem(10090), new GameItem(9978)),
		COPPER_LONGTAIL(5552, 9379, 9, 161, 16, new GameItem(526), new GameItem(10091), new GameItem(9978)),
		CERULEAN_TWITCH(5550, 9375, 11, 164.5, 18, new GameItem(526), new GameItem(10089), new GameItem(9978)),
		TROPICAL_WAGTAIL(5548, 9348, 19, 195, 20, new GameItem(526), new GameItem(10087), new GameItem(9978));
