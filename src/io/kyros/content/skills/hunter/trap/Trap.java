package io.kyros.content.skills.hunter.trap;
...
import io.kyros.util.RandomGen;
...
public abstract class Trap {
	...
	public int successFormula(NPC npc) {
		...
		if (player.getPerkSytem().gameItems.stream().anyMatch(item -> item.getId() == 33086) && Misc.random(0, 100) < 10) {
			chance = (int) (chance * 2.1);
		}
		return chance;
	}
