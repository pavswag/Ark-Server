...
public class JewelryMaking extends CraftingData {
	...
	private static final int[][] NECKLACES = {
			...
			{ 1658, 1605, 29, 60 }, 
			{ 1660, 1603, 40, 75 }, 
			{ 1662, 1601, 56, 90 }, // DIAMOND
			{ 1664, 1615, 72, 105 }, // DRAGONSTONE
			{ 6577, 6573, 82, 120 }, 
			{ 19535, 19493, 92, 165 }  //ZENYTE
	};
	...
	private final static int[][] MOULD_INTERFACE_IDS = {
			/* Rings */
			{ 1637, 1639, 1641, 1643, -1, 6575, 19538 },
			/* Neclece */
	...
	public static void mouldItem(Player c, int item, int amount) {
		...
		if (item == 1645) {
			c.sendMessage("This item may not be crafted.");
			return;
		}
