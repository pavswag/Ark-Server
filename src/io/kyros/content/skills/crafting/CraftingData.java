...
public class CraftingData extends SkillHandler {
	...
	public enum tanningData {
		...
		tanningData(final int[][] buttonId, final int hideId, final int leatherId, final int price, final int[] frameId, final String name) {
	...
	public enum battlestaveDialogueData {
        ...
        private final int battlestaff;

		battlestaveDialogueData(final int orb, final int battlestaff) {
			this.orb = orb;
	...
	public enum battlestaveData {
		...
		battlestaveData(final int[][] buttonId, final int orb, final int product, final int level, final double xp, final int amount) {
			this.buttonId = buttonId;
			this.orb = orb;
	...
	public enum chargeOrbData {
		...
		chargeOrbData(final int[][] objectId, final int spellId, final int orb, final int product, final int level, final double xp, final int amount, final int gfx, final int spellConfig) {
	...
	public enum braceletData {
		...
		braceletData(final int[][] buttonId, final int gem, final int product, final int level, final double xp, final int amount) {
			this.buttonId = buttonId;
			this.gem = gem;
			this.product = product;
			this.level = level;
	...
	public enum cutGemData {
		...
		cutGemData(final int uncut, final int cut, final int level, final double xp, final int animation) {
			this.uncut = uncut;
			this.cut = cut;
			this.level = level;
			this.xp = xp;
