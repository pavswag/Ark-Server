					...
					CycleEventHandler.getSingleton().addEvent(3, c, new CycleEvent() {
						...
						public void execute(CycleEventContainer container) {
							...
							if (c.playerIsCrafting == true) {
								...
								for (leatherData value : leatherData.values()) {
									if (l == value &&value.name().contains("DHIDE")) {
										for (TaskMasterKills taskMasterKills : c.getTaskMaster().taskMasterKillsList) {
											if (taskMasterKills.getDesc().equalsIgnoreCase("Craft @whi@d'hide body")) {
									...
									if (l == value &&value.name().contains("BLACK_DHIDE_BODY")) {
										for (TaskMasterKills taskMasterKills : c.getTaskMaster().taskMasterKillsList) {
											if (taskMasterKills.getDesc().equalsIgnoreCase("Craft @whi@Black d'hide body")) {
												taskMasterKills.incrementAmountKilled(1);
												c.getTaskMaster().trackActivity(c, taskMasterKills);
												break;
											}
									...
									if (l == value &&value.name().contains("BLACK_DHIDE_CHAPS")) {
										for (TaskMasterKills taskMasterKills : c.getTaskMaster().taskMasterKillsList) {
											if (taskMasterKills.getDesc().equalsIgnoreCase("Craft @whi@Black d'hide chaps")) {
												taskMasterKills.incrementAmountKilled(1);
												c.getTaskMaster().trackActivity(c, taskMasterKills);
												break;
											}
									...
									if (l == value &&value.name().contains("BLACK_DHIDE_VAMBRACES")) {
										for (TaskMasterKills taskMasterKills : c.getTaskMaster().taskMasterKillsList) {
											if (taskMasterKills.getDesc().equalsIgnoreCase("Craft @whi@Black d'hide vembraces")) {
												taskMasterKills.incrementAmountKilled(1);
												c.getTaskMaster().trackActivity(c, taskMasterKills);
												break;
											}
