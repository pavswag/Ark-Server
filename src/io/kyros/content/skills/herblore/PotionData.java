...
public class PotionData {
	...
	/**
	 * If you add new potions check out {@link io.kyros.content.skills.SkillInterfaces} if you need to
	...
	public enum FinishedPotions {
		...
		REJUV_POT(new GameItem(20699), 1, 4, new GameItem(20697), new GameItem(20698))
		;
