...
public class Task {
	 ...
	 * @return True if the Task is a crystalline task
	 */
	public boolean isCrystalline() {
		return getPrimaryName().contains("crystalline");
	}
	...
	/**
	 * The master name of the task to differentiate it from others (formatted)
	 *
	 * @return the name
	 */
