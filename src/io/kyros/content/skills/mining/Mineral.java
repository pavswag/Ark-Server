...
public enum Mineral {
			...
			CLAY(new int[] { 7487, 7454, 11363 }, "none", 1, 18, 0, 3, 15, 2500, false, generateExclusive(434)),
			COPPER(new int[] { 7484, 11961, 11960, 11962, 13709, 11161 }, "bronze", 1, 18, 5, 5, 15, 2500, false, generateExclusive(436)),
			...
			GEM(new int[] { 9030, 33255, 33256 }, "none", 40, 5, 20, 25, 20, 2500, false, new MineralReturn() {
