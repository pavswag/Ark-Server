...
public enum FletchableBow {
	NORMAL_SHORTBOW(50, 841, 6678, 1, 5),
	NORMAL_LONGBOW(48, 839, 6684, 10, 10),
	OAK_SHORTBOW(54, 843, 6679, 20, 16.5),
	OAK_LONGBOW(56, 845, 6685, 25, 25),
	WILLOW_SHORTBOW(60, 849,6680, 35, 33.25),
	WILLOW_LONGBOW(58, 847, 6686, 40, 41.5),
	MAPLE_SHORTBOW(64, 853, 6681, 50, 50),
	MAPLE_LONGBOW(62, 851, 6687, 55, 58.2),
	YEW_SHORTBOW(68, 857, 6682,65, 67.5),
	YEW_LONGBOW(66, 855, 6688, 70, 75),
	MAGIC_SHORTBOW(72, 861, 6683, 80, 83.2), 
	MAGIC_LONGBOW(70, 859, 6689, 85, 91.5);
