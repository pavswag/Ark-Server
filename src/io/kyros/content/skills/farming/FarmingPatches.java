...
public enum FarmingPatches {
	...
	/**
	 * Donator Zone Herb Patches
	 */

	DZ_HERB(new Position(1944, 5368), new Position(1946, 5370), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),
	DZ_HERB_NEW(new Position(2385, 3813), new Position(2387, 3815), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),
	...
	WILDY_HERB(new Position(3143, 3673), new Position(3145, 3676), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.HERB),
	WILDY_FLOWER(new Position(3139, 3669), new Position(3141, 3670), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.FLOWER),
	WILDY_ALLOTMENT_NORTH(new Position(3135, 3669), new Position(3140, 3675), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.ALLOTMENT),
	WILDY_ALLOTMENT_SOUTH(new Position(3140, 3665), new Position(3144, 3672), Farming.HARVEST_ANIMATION, Items.SEED_DIBBER, Items.SECATEURS, SeedType.ALLOTMENT),
	...
	LUMBRIDGE_TREE(new Position(3191, 3229, 0), new Position(3195, 3233, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.TREE),
	VARROCK_TREE(new Position(3227, 3457, 0), new Position(3231, 3461, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.TREE),
	FALADOR_TREE(new Position(3002, 3371, 0), new Position(3006, 3375, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.TREE),
	TAVERLY_TREE(new Position(2934, 3436, 0), new Position(2938, 3440, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.TREE),
	STRONGHOLD_TREE(new Position(2434, 3413, 0), new Position(2438, 3417, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.TREE),

	STRONGHOLD_FRUIT_TREE(new Position(2474, 3444, 0), new Position(2477, 3447, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
	CATHERBY_FRUIT_TREE(new Position(2859, 3432, 0), new Position(2862, 3435, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
	MAZE_FRUIT_TREE(new Position(2488, 3178, 0), new Position(2491, 3181, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
	BRIMHAVEN_FRUIT_TREE(new Position(2763, 3211, 0), new Position(2766, 3214, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),
	LLETYA_FRUIT_TREE(new Position(2345, 3160, 0), new Position(2348, 3163, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.FRUIT_TREE),

	PORT_SARIM_SPIRIT_TREE(new Position(3058, 3256, 0), new Position(3062, 3260, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.SPIRIT_TREE),
	BRIMHAVEN_SPIRIT_TREE(new Position(2800, 3201, 0), new Position(2804, 3205, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.SPIRIT_TREE),
	ETCETRIA_SPIRIT_TREE(new Position(2611, 3856, 0), new Position(2615, 3860, 0), Farming.HARVEST_CHOPPING, Items.TROWEL, Items.SPADE, SeedType.SPIRIT_TREE),
