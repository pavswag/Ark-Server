...
public enum Plants {
	...
	APPLE_TREE(Items.APPLE_SAPLING, Items.COOKING_APPLE, 8, 8 + 13, 8 + 19, 8 + 25, 8 + 26, 27, 160, SeedType.FRUIT_TREE, 22.0, 1199.0, 8.5, 7),
	BANANA_TREE(Items.BANANA_SAPLING, Items.BANANA, 35, 35 + 13, 35 + 19, 35 + 25, 35 + 26, 33, 160, SeedType.FRUIT_TREE, 28.0, 1750.5, 10.5, 7),
	ORANGE_TREE(Items.ORANGE_SAPLING, Items.ORANGE, 72, 72 + 13, 72 + 19, 72 + 25, 72 + 26, 39, 160, SeedType.FRUIT_TREE, 35.0, 2470.2, 13.5, 7),
	CURRY(Items.CURRY_SAPLING, Items.CURRY_LEAF, 15, 15 + 13, 15 + 19, 15 + 25, 15 + 26, 39, 160, SeedType.FRUIT_TREE, 35.0, 2470.2, 13.5, 7),
	PINEAPPLE(Items.PINEAPPLE_SAPLING, Items.PINEAPPLE, 136, 136 + 13, 136 + 19, 136 + 25, 136 + 26, 39, 160, SeedType.FRUIT_TREE, 35.0, 2470.2, 13.5, 7),
	PAPAYA(Items.PAPAYA_SAPLING, Items.PAPAYA_FRUIT, 163, 163 + 13, 163 + 19, 163 + 25, 163 + 26, 39, 160, SeedType.FRUIT_TREE, 35.0, 2470.2, 13.5, 7),
	PALM(Items.PALM_SAPLING, Items.COCONUT, 200, 200 + 13, 200 + 19, 200 + 25, 200 + 26, 39, 160, SeedType.FRUIT_TREE, 35.0, 2470.2, 13.5, 7),
	...
	WOAD(5099, 1793, 23, 0, 0, 25, 60, SeedType.FLOWER, 20, 115, 4),
