...
public enum SkillcapePerks {
	...
	FIRE_MAX_CAPE( 13329,21186),
	AVAS_MAX_CAPE( 13337),
	ACHIEVEMENT_CAPE(13069),
	...
	INFERNAL_MAX_CAPE(21285,21284),
	MASORI_MAX_CAPE(27363),
	...
	public static boolean isWearingMaxCape(Player player) {
		return player.getItems().isWearingAnyItem(Items.COMPLETIONIST_CAPE) ||player.getItems().isWearingAnyItem(23859) ||
				ACHIEVEMENT_CAPE.isWearing(player) ||
				MAX_CAPE.isWearing(player) ||
				MYTHICAL_MAX_CAPE.isWearing(player) ||
				...
				IMBUED_SARADOMIN_MAX_CAPE.isWearing(player)||
				IMBUED_ZAMORAK_MAX_CAPE.isWearing(player)||
				IMBUED_GUTHIX_MAX_CAPE.isWearing(player);
	}
